          ...
          <div className="glass text-center p-12 mb-12 w-full max-w-4xl mx-auto border border-opacity-20 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              ...
              <div className="glass-dark border border-white/10 rounded-xl p-8 flex flex-col items-center hover:scale-105 transition-all duration-300">
                ...
                <h2 className="text-2xl font-bold mb-4 gradient-text">Already have an account?</h2>
                <p className="text-gray-300 text-center mb-8">
                  Login to your existing account to manage your bookings, services, and customers.
                </p>
                <Link 
                  href="/login"
              ...
              <div className="glass-dark border border-white/10 rounded-xl p-8 flex flex-col items-center hover:scale-105 transition-all duration-300">
                ...
                <h2 className="text-2xl font-bold mb-4 gradient-text">New to Smart Booking?</h2>
                <p className="text-gray-300 text-center mb-8">
                  Create a new account and set up your business with our step-by-step wizard.
                </p>
                <Link 
                  href="/register"
