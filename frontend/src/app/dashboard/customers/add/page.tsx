...
import { ChevronLeft, User, Mail, Phone, MapPin, ClipboardList, ArrowLeftIcon } from 'lucide-react'
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                />
                <Mail className={`absolute left-3 top-2.5 w-5 h-5 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
              </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center justify-center h-10 px-3 rounded-l-lg ${darkMode ? 
                      'bg-gray-800 border-gray-700 text-white hover:bg-gray-700' : 
                      'bg-gray-50 border-gray-300 text-gray-900 hover:bg-gray-100'
                    } border border-r-0 focus:outline-none transition-colors`}
                  >
                    {countryCode}
                    <ChevronLeft className={`w-4 h-4 ml-1 transform rotate-90 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                  </button>
                  
                  {/* Dropdown menu */}
                  {dropdownOpen && (
                    <div className={`absolute z-10 mt-1 w-48 overflow-auto ${darkMode ? 
                      'bg-gray-800 border-gray-700 shadow-lg shadow-black/30' : 
                      'bg-white border-gray-300 shadow-lg'
                    } border rounded-lg py-1 max-h-60`}
                    style={{ bottom: 'auto', top: '100%' }}>
                      {countryCodes.map((country) => (
                        <button
                          ...
                          className={`block w-full text-left px-4 py-2 ${darkMode ? 
                ...
                <input
                  ...
                  required
                  className={`w-full rounded-r-lg ${darkMode ? 
                    'bg-gray-800 border-gray-700 text-white focus:border-purple-500' : 
                    'bg-gray-50 border-gray-300 text-gray-900 focus:border-purple-600'
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                />
                <MapPin className={`absolute left-3 top-2.5 w-5 h-5 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                />
                <ClipboardList className={`absolute left-3 top-2.5 w-5 h-5 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
              </div>
            </div>
        ...
        <div className="lg:w-1/3 space-y-6">
          <div className="rounded-xl backdrop-blur-md border border-white/10 p-6 bg-blue-900/30">
            ...
            <p>Add new customers to your business database. Complete all required fields marked with an asterisk (*).</p>
          </div>

          <div className="rounded-xl backdrop-blur-md border border-white/10 p-6 bg-purple-900/30">
            <h2 className="text-xl font-bold mb-4">Contact Information</h2>
            <p>Ensure contact details are accurate for future communications and appointment notifications.</p>
          </div>
          ...
          <div className="rounded-xl backdrop-blur-md border border-white/10 p-6 bg-emerald-900/30">
            ...
            <p>Customer data is stored securely and used only for business purposes in compliance with data protection regulations.</p>
          </div>
        </div>
      </div>
    </div>
