...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    const savedAppointmentReminders = localStorage.getItem('appointmentReminders')
  ...
  return (
    <div className={`space-y-8 animate-fadeIn ${darkMode ? 'dark-content' : 'light-content'}`}>
      <div>
        <h1 className={`text-2xl font-semibold ${darkMode ? 'text-white' : 'text-gray-800'}`}>Settings</h1>
        <p className={`mt-1 text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
          Manage your account and application preferences.
        </p>
      </div>
      
      <div className={`p-6 rounded-lg ${darkMode ? 'glass-dark' : 'glass-light'}`}>
        <h2 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Personal Information</h2>
        <div className="mb-6">
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Email</p>
          <p className={darkMode ? 'text-white' : 'text-gray-800'}>{user?.email || 'Not available'}</p>
        </div>
        <div className="mb-6">
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Name</p>
          <p className={darkMode ? 'text-white' : 'text-gray-800'}>{user?.name || 'Not available'}</p>
        </div>
        <div className="mb-6">
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Business Name</p>
          <p className={darkMode ? 'text-white' : 'text-gray-800'}>{user?.businessName || 'Not available'}</p>
        </div>
      </div>
      ...
      <div className={`p-6 rounded-lg ${darkMode ? 'glass-dark' : 'glass-light'}`}>
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <div>
              <h3 className={darkMode ? 'text-white' : 'text-gray-800'}>Theme Mode</h3>
          ...
          <div>
            <h3 className={`font-medium mb-2 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Accent Color</h3>
            <div className="flex space-x-3">
              {['purple', 'blue', 'indigo', 'teal', 'pink'].map(color => (
                <button
                  key={color}
      ...
      <div className={`p-6 rounded-lg ${darkMode ? 'glass-dark' : 'glass-light'}`}>
        <h2 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Notification Preferences</h2>
        <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
        ...
        <div className="space-y-4">
          <div className={`flex justify-between items-center py-2 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            <div>
              <h3 className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>Email Notifications</h3>
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className={`w-11 h-6 ${darkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600`}></div>
            </label>
          </div>
          
          <div className={`flex justify-between items-center py-2 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            <div>
              <h3 className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>Appointment Reminders</h3>
              <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Receive reminders about upcoming appointments</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input 
                type="checkbox" 
                ...
                onChange={(e) => handleNotificationToggle('appointment', e.target.checked)}
              />
              <div className={`w-11 h-6 ${darkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600`}></div>
            </label>
          </div>
          ...
          <div className="flex justify-between items-center py-2">
            <div>
              <h3 className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>Marketing Emails</h3>
              <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Receive promotional and marketing emails</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input 
                type="checkbox" 
      ...
      <div className={`p-6 rounded-lg ${darkMode ? 'glass-dark' : 'glass-light'}`}>
        <h2 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Business Hours</h2>
        <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
        ...
        <div className="space-y-4">
          {businessHours.map((daySchedule, index) => (
            <div key={daySchedule.day} className={`flex flex-wrap gap-3 items-center py-2 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <div className="w-28">
                <h3 className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>{daySchedule.day}</h3>
              </div>
      ...
      <div className={`p-6 rounded-lg ${darkMode ? 'glass-dark' : 'glass-light'}`}>
        <h2 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Service Link</h2>
        <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
          {hasServiceLink 
        ...
        <div className="space-y-4">
          <div className="flex flex-col space-y-2">
            <label htmlFor="serviceName" className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Service Name</label>
            <input
              type="text"
              id="serviceName"
              value={serviceName}
          ...
          <div className="flex flex-col space-y-2">
            <label htmlFor="serviceLink" className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Service URL</label>
            <input
              type="url"
              id="serviceLink"
              value={serviceLink}
      ...
      <div className={`p-6 rounded-lg ${darkMode ? 'glass-dark' : 'glass-light'}`}>
        <h2 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Danger Zone</h2>
        <button 
