...
import { ArrowLeft, Clock, ClipboardList, Check, ChevronDown, UserPlus, X } from 'lucide-react'
    ...
    const fetchService = async () => {
      try {
        ...
        if (service) {
          ...
          // Set employee IDs from service if available
          if (service.assignedEmployeeIds && Array.isArray(service.assignedEmployeeIds)) {
            setSelectedEmployeeIds(service.assignedEmployeeIds)
          }
        } else {
