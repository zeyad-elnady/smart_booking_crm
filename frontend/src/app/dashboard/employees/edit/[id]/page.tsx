...
import { Employee, EmployeeData, employeeRoles, doctorSpecializations } from "@/types/employee";
...
export default function EditEmployee() {
  ...
  // Load employee data on initial render
  useEffect(() => {
    const fetchEmployee = async () => {
      try {
        ...
        // Remove the _id field from the form data
        const { _id, createdAt, updatedAt, ...employeeData } = employee;
