...
connectDB().catch((error) => {
   ...
   // Continue with local storage mode
});
...
app.post("/api/db/sync", async (req, res) => {
   try {
      ...
      syncDatabases()
         .then((success) => {
            console.log(
               `Manual sync completed with status: ${
...
try {
   app.listen(PORT, HOST, () => {
      ...
      console.log(
         `API available at http://localhost:${PORT} and http://<your-ip-address>:${PORT}`
      );
      ...
      console.log("==========================================================");
      console.log(
         "Server started successfully with CORS enabled for all origins"
      );
